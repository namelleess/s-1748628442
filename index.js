document.addEventListener("DOMContentLoaded", function() {
  const e = {
    ...
    t = {
      website: "https://api.adkey-seo.com/api/website/get-website/777",
      games: "https://api.adkey-seo.com/api/website/get-games/gambling",
      payments: "https://api.adkey-seo.com/api/website/get-payments/777",
    ...
    e.forEach((e) => {
      const n = (function(e) {
        ...
        (x.className = "bonusDetailsContent"),
          ...
          w.appendChild(x);
        const T = document.createElement("div");
        T.className = "bonusDetailBlock bonusDetailBlockAdd";
        const L = document.createElement("div");
        L.className = "claimBonus";
        const P = document.createElement("a");
        (P.href = `casino.html?id=${e.id}`),
          P.setAttribute("aria-label", "Play game");
        const A = document.createElement("span");
        return (
          (A.className = "bonusButton btn btn--medium"),
          (A.textContent = "Get The Bonus"),
          P.appendChild(A),
          L.appendChild(P),
          T.appendChild(L),
          y.appendChild(C),
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    if (e) {
      fetch("https://api.adkey-seo.com/api/website/get-website/777")
        .then((e) => {
